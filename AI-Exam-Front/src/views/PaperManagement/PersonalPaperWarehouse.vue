  ...
  <div class="papers-main-box">
    ...
    >
      <el-form :model="formData" ref="formRef">
        ...
        <el-form-item label="评分模式" :label-width="formLabelWidth" prop="grading_mode" required>
          <el-select v-model="formData.grading_mode" placeholder="请选择评分模式">
            <el-option label="宽松模式（单LLM评分）" value="LENIENT"/>
            <el-option label="严格模式（三LLM投票）" value="STRICT"/>
          </el-select>
        </el-form-item>
