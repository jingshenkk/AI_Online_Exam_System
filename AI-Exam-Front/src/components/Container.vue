<template>
  <div class="app-container-main">
    <div class="container-main-left-box">
      <div class="logo-box">
        <span style="color: #fff; font-size: 16px; letter-spacing: 2px; font-weight: bold;">智能评分考试系统</span>
      </div>
...
import {
  BookMarked, Notebook, Files, SearchCheck, FileTerminal,
...
const menuIconEnum: any = {
  ...
  '10004': BookOpenCheck, '10005': SearchCheck, '10006': GraduationCap,
  '10007': Users, '10008': Laptop2, '10009': SearchCheck,
