...
import PaperResultDetailTeacher from "../views/ExamResult/PaperResultDetailTeacher.vue";
import ScoringPointManagement from "../views/QuestionManagement/ScoringPointManagement.vue";
...
const routers: any = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/paperResultTeacher/:id',
        component: PaperResultDetailTeacher,
      },
      {
        path: '/scoringPoints/:id',
        component: ScoringPointManagement,
      }
    ]
  }
]
